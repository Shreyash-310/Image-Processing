...
class BatchGenerator(Sequence):
    ...
    def __len__(self):
        return int(
            np.ceil(float(len(self.images)) / self.config['BATCH_SIZE']))
            ...
            for obj in all_objs:
                if obj['xmax'] > obj['xmin'] and obj['ymax'] > obj['ymin'] and \
                    ...
                    if grid_x < self.config['GRID_W'] and grid_y < self.config[
                        ...
                        0:4] = box
                        y_batch[
                            instance_count, grid_y, grid_x, best_anchor, 4] = 1.
                        y_batch[
